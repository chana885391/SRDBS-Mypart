         ...
         for(MyFile mylist: listofrecords){
            ...
            chking_normal = true;
              ...
              if(chking_zipenc){
                    ...
                    join(S_Complete,D_Complete);
                    boolean isFilesDeleted = delete(S_Complete);
          ...
          join(S_Complete,D_Complete);
          boolean isFilesDeleted = delete(S_path);
          System.out.print("All Files Are Delete :" + isFilesDeleted);
          ...
          for(MyFile myfile: listoffiles){
                ...
                for(MyFile dbfile: list){
                  ...
                  if(chking_zipenc){
                    ...
                    if(myfile.getName().equalsIgnoreCase(dbfile.getName().replaceAll(".zip.enc",""))&& myfile.getHash().equalsIgnoreCase(dbfile.getHash())){      
                            pass = true;
                            System.out.println("Pass");
                    }
                        else{
                      ...
                      //  System.out.println("Fail");
                       ...
                       if(myfile.getName().equalsIgnoreCase(dbfile.getName().replaceAll(".zip",""))&& myfile.getHash().equalsIgnoreCase(dbfile.getHash())){      
                            pass = true;
                            System.out.println("Pass");
                         }
                         else{
      ...
      for (int i = 0; i < listOfFiles.length; i++) 
      {
        ...
        DeleteCheck = DelFile.delete();
            ...
            if(!DeleteCheck){
                ...
                System.out.println("File is Deleted :"+ files1);
            }
