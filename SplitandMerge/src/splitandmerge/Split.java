...
public class Split extends javax.swing.JFrame {
    ...
    String S_Path1 ="C:/Users/chana/Desktop/test/Source";
    String Destination = "C:/Users/chana/Desktop/test/Split";
    
    String S_Complete = S_Path1 + "/" + FileName;
    String D_Complete = Destination+ "/" +FileName;
...
*/
    ...
    private void btn_StartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_StartActionPerformed
       ...
       // String path = "C:/Users/chana/Desktop/test/join";
        ...
        for(File file : listOfFiles ){
                ...
                try{
              map.put(file.getName(), getHash(S_Complete));
                }
                 ...
                 fileList.add(map);
                 split(S_Complete, D_Complete, ainteger);
                      //  saveFile(fileList);
    ...
    public String getHash(String Scomplete_path)
    ...
    /*
     private void saveFile(List<Map<String,String>> fileList) {                                         
        try {
            
            String[] sqls = new String[fileList.size()];
            int i = 0;
            for(Map aa : fileList) {
                Entry e = (Entry)aa.entrySet();
               // String sql = "insert into Full_File(Fname,FSize,HashValue,Up_date) values('"+e.getKey()+"' ,'"+e.getValue()+""');
              //  sqls[i] = sql;
